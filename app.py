...
# CNN and Decision Tree accuracies (assumed to be stored in some manner)
cnn_accuracy = 96.312314271926885  # Example accuracy, you should replace with actual value
dt_accuracy = 28.06   # Example accuracy, you should replace with actual value
...
def show_accuracy():
    return render_template('index.html', cnn_accuracy=cnn_accuracy, dt_accuracy=dt_accuracy)
